...
plottingData <- plottingData %>%
  mutate(Game_date = as.Date(trimws(Game_date), format = "%d-%m-%Y"))

Game_date <- format(max(plottingData$Game_date, na.rm = TRUE), "%d-%m-%Y")
...
plot_metric_dashboard <- function(metric, metric_label, metric_is_percent = FALSE) {
  ...
  metric_limits <- base_dat %>%
  ungroup() %>%
  summarise(
    min_val = suppressWarnings(min(as.numeric(.data[[metric]]), na.rm = TRUE)),
    max_val = suppressWarnings(max(as.numeric(.data[[metric]]), na.rm = TRUE))
  )

  min_val <- metric_limits %>% pull(min_val)
  max_val <- metric_limits %>% pull(max_val)
...
plot_metric_dashboard("Pass_Success", "Passing Success", TRUE)
...
plot_metric_dashboard("Successful_Passes", "Successful Passes", FALSE)
...
plot_metric_dashboard("receiving_Suc", "Receiving Success", TRUE)
...
```{r}
#| title: Prog Passes
#| label: Pps graph Season P match
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
plot_metric_dashboard("Prog_Passes", "Progressive Passes", FALSE)
...
```{r}
#| title: Prog Passes
#| label: Pps graph Season P match EPL
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: Attacking Threat
#| label: threat graph Season P match CL
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: Defensive Threat
#| label: Def threat graph Season P match CL
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: ADs
#| label: Home AD graph Season P match CL
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: Prog Passes
#| label: Pps graph Season P match CL
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: ADs
#| label: Home AD graph Season P match FAC
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: Prog Passes
#| label: Pps graph Season P match FAC
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: ADs
#| label: Home AD graph Season P match LC
#| echo: false
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| title: Prog Passes
#| label: Pps graph Season P match LC
#| echo: false
#| message: false
#| warning: false
#| results: asis
